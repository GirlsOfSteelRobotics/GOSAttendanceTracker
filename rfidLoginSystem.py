...
def log_attendance(service_key, name, id_num):
    ...
    sheet_tab.append_row([current_time.strftime("%m/%d/%y %H:%M %p"), id_num, name, "General Meeting"])
...
def log_visitor(service_key, name, team):
    ...
    sheet_tab.append_row([current_time.strftime("%m/%d/%y %H:%M %p"), team, name, "SCRA Open Meeting"])
